...
class Box():
    ...
    def find_underBoxId(self, packer, lastBoxQueueNumber):
        ...
        for box in packer.queue[1:lastBoxQueueNumber:]:
            # Левый верхний
            if self.startCoordinate[0] > box.startCoordinate[0] and self.startCoordinate[1] > box.startCoordinate[1] and self.startCoordinate[0] < box.endCoordinate[0] and self.startCoordinate[1] < box.endCoordinate[1]:
                intersection_area = (box.endCoordinate[0] - self.startCoordinate[0]) * (box.endCoordinate[1]- self.startCoordinate[1])
                ...
                if abs(iou) > 1:
                    if abs(iou) > maxInterception:
                        ...
                        underBoxId = box.id
            # Правый верхний
            if self.endCoordinate[0] > box.startCoordinate[0] and self.startCoordinate[1] > box.startCoordinate[1] and self.endCoordinate[0] < box.endCoordinate[0] and self.startCoordinate[1] < box.endCoordinate[1]:
                intersection_area = (self.endCoordinate[0] - box.startCoordinate[0]) * (box.endCoordinate[1]- self.startCoordinate[1])
                iou = intersection_area / float(self.area + box.area - intersection_area)
                if abs(iou) > 1:
                    if abs(iou) > maxInterception:
                        maxInterception = abs(iou)
                        underBoxId = box.id
            # Левый нижний
            if self.startCoordinate[0] > box.startCoordinate[0] and self.endCoordinate[1] > box.startCoordinate[1] and self.startCoordinate[0] < box.endCoordinate[0] and self.endCoordinate[1] < box.endCoordinate[1]:
                intersection_area = (box.endCoordinate[0] - self.startCoordinate[0]) * (self.startCoordinate[1] - box.startCoordinate[1])
                iou = intersection_area / float(self.area + box.area - intersection_area)
                if abs(iou) > 1:
                    if abs(iou) > maxInterception:
                        maxInterception = abs(iou)
                        underBoxId = box.id
            # Правый нижний
            if self.endCoordinate[0] > box.startCoordinate[0] and self.endCoordinate[1] > box.startCoordinate[1] and self.endCoordinate[0] < box.endCoordinate[0] and self.endCoordinate[1] < box.endCoordinate[1]:
                intersection_area = (self.endCoordinate[0] - box.startCoordinate[0]) * (self.endCoordinate[1] - box.startCoordinate[1])
                iou = intersection_area / float(self.area + box.area - intersection_area)
                if abs(iou) > 1:
                    if abs(iou) > maxInterception:
                        maxInterception = abs(iou)
